...
# Models.
#----------------------------------------------------------------------------#
# Every model is in models.py file
...
def search_venues():
    ...
    # the ilike attribute is used to handle case sensitive searches
...
def show_venue(venue_id):
    ...
    shows = Show.query.filter(Show.venue_id == venue_query.id).\
...
def show_artist(artist_id):
    ...
    shows = Show.query.filter(Show.artist_id == artist_query.id).\
...
def edit_artist_submission(artist_id):
    ...
    try:
        ...
        seeking_venue = request.form.get(
            'seeking_venue', type=boolean, default=False)
        seeking_description = request.form.get('seeking_description')
        artist = Artist.query.get(artist_id)
...
def edit_venue_submission(venue_id):
    ...
    try:
        ...
        seeking_talent = request.form.get(
            'seeking_talent', type=boolean, default=False)
        seeking_description = request.form.get('seeking_description')
        image_link = request.form.get('image_link')
        venue = Venue.query.get(venue_id)
